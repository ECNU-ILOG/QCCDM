...
class MIRT(CDM):
    def __init__(self, user_num, item_num, latent_dim, a_range=None, wandb=True, device='cuda'):
    ...
    def train(self, np_train, np_test, q, batch_size, epoch=10, lr=0.001) -> ...:
        self.irt_net = self.irt_net.to(self.device)
        ...
        for e in range(epoch):
            ...
            for batch_data in tqdm(train_data, "Epoch %s" % e):
                user_id, item_id, know_emb, response = batch_data
